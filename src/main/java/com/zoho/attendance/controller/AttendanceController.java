...
public class AttendanceController {
	...
	private static final Date Entry_date = null;
	@Autowired
	AttendanceService attendanceservice;
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> countByDepartmentIdAndMonthAndAvailable(@RequestParam String employeeid,@RequestParam int departmentid,@RequestParam String month,@RequestParam String available) {
		 HttpHeaders headers = new HttpHeaders();
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> countByEmployeeIdAndDepartmentIdAndMonth(@RequestParam String employeeid,@RequestParam int departmentid,@RequestParam Date entry_date) {
		 HttpHeaders headers = new HttpHeaders();
	        
	        try {   	
	    		return ResponseEntity.status(HttpStatus.CREATED).headers(headers).body( attendanceservice.countByEmployeeIdAndDepartmentIdAndMonth(employeeid,departmentid,entry_date));
	    }catch (Exception e) {
	    	headers.add("Message", "false");
	    	return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).headers(headers).body("Failed to add the user");
		}
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> countByEmployeeIdAndDepartmentId(@RequestParam String employeeid,@RequestParam int departmentid) {
		 HttpHeaders headers = new HttpHeaders();
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> countByEmployeeIdAndDepartmentIdAndAvailable(@RequestParam String employeeid,@RequestParam int departmentid,@RequestParam string available) {
		 HttpHeaders headers = new HttpHeaders();
	        try {   	
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> findBydeptid(@RequestParam String departmentid) {
		 HttpHeaders headers = new HttpHeaders();
	        ...
	        try {   	
	        	//System.out.println("en da ipdi "+employeeid+employeeservice.findByempid(employeeid));
	    		return ResponseEntity.status(HttpStatus.CREATED).headers(headers).body( attendanceservice.findByempid(departmentid));
	    }catch (Exception e) {
	    	headers.add("Message", "false");
	    	return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).headers(headers).body("Failed to add the user");
		}
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> sortdeptview(@RequestParam int departmentId,@RequestParam String month,@RequestParam String shift) {
		 HttpHeaders headers = new HttpHeaders();
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public AttendanceDetail findByName(@RequestParam String employeeid,@RequestParam int departmentid) {
	  ...
	  @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> updateUser(@RequestParam String employeeid,@RequestParam String available,@RequestParam Date entry_date) {
		  HttpHeaders headers = new HttpHeaders();
	        
	        try {   	
	    		return ResponseEntity.status(HttpStatus.CREATED).headers(headers).body(attendanceservice.updateUser(employeeid,available,Entry_date));
	    }catch (Exception e) {
	    	headers.add("Message", "false");
	    	return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).headers(headers).body("Failed to add the user");
		}
	  ...
	  @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> deleteBydeptid(@RequestParam int departmentid) {
		  HttpHeaders headers = new HttpHeaders();
	    ...
	    @CrossOrigin
	    @ResponseBody
	    public String deleteByUserNameAndPassword(@RequestParam String employeeid, @RequestParam int departmentid) {
